...
public class JogoDaVelha {
    public static void main(String[] args) {
        ...
        for (int linhaEscolhidaUsuario = 0; linhaEscolhidaUsuario < 3; linhaEscolhidaUsuario++) {
            for (int colunaEscolhidaUsuario = 0; colunaEscolhidaUsuario < 3; colunaEscolhidaUsuario++) {
                if (isJogador1) {
